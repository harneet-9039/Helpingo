...
public class HomeScreen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1 = findViewById(R.id.first_llt);
        l2 = findViewById(R.id.second_llt);
        l3 = findViewById(R.id.third_llt);
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.first_llt)
        {
            startActivity(new Intent(HomeScreen.this,SpotHelp.class));
        }
        else if(view.getId()==R.id.second_llt)
        {
